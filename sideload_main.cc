 ...
 public:
  ...
  void SendStatusUpdate(
    ...
    if (status_ != status && (status == UpdateStatus::VERIFYING || status == UpdateStatus::FINALIZING)) {
      ...
      ReportStatus(base::StringPrintf("ui_print ======================="));
      ReportStatus(base::StringPrintf("ui_print "));
      ReportStatus(base::StringPrintf("ui_print                AAA               BBBBBBBBBBBBBBBBB           CCCCCCCCCCCCC"));
      ReportStatus(base::StringPrintf("ui_print               A:::A              B::::::::::::::::B       CCC::::::::::::C"));
      ReportStatus(base::StringPrintf("ui_print              A:::::A             B::::::BBBBBB:::::B    CC:::::::::::::::C"));
      ReportStatus(base::StringPrintf("ui_print             A:::::::A            BB:::::B     B:::::B  C:::::CCCCCCCC::::C"));
      ReportStatus(base::StringPrintf("ui_print            A:::::::::A             B::::B     B:::::B C:::::C       CCCCCC"));
      ReportStatus(base::StringPrintf("ui_print           A:::::A:::::A            B::::B     B:::::BC:::::C              "));
      ReportStatus(base::StringPrintf("ui_print          A:::::A A:::::A           B::::BBBBBB:::::B C:::::C              "));
      ReportStatus(base::StringPrintf("ui_print         A:::::A   A:::::A          B:::::::::::::BB  C:::::C              "));
      ReportStatus(base::StringPrintf("ui_print        A:::::A     A:::::A         B::::BBBBBB:::::B C:::::C              "));
      ReportStatus(base::StringPrintf("ui_print       A:::::AAAAAAAAA:::::A        B::::B     B:::::BC:::::C              "));
      ReportStatus(base::StringPrintf("ui_print      A:::::::::::::::::::::A       B::::B     B:::::BC:::::C              "));
      ReportStatus(base::StringPrintf("ui_print     A:::::AAAAAAAAAAAAA:::::A      B::::B     B:::::B C:::::C       CCCCCC"));
      ReportStatus(base::StringPrintf("ui_print    A:::::A             A:::::A   BB:::::BBBBBB::::::B  C:::::CCCCCCCC::::C"));
      ReportStatus(base::StringPrintf("ui_print   A:::::A               A:::::A  B:::::::::::::::::B    CC:::::::::::::::C"));
      ReportStatus(base::StringPrintf("ui_print  A:::::A                 A:::::A B::::::::::::::::B       CCC::::::::::::C"));
      ReportStatus(base::StringPrintf("ui_print AAAAAAA                   AAAAAAABBBBBBBBBBBBBBBBB           CCCCCCCCCCCCC"));
      ReportStatus(base::StringPrintf("ui_print "));
      ReportStatus(base::StringPrintf("ui_print ==========="));
